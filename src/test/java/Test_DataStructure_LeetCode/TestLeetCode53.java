...
public class TestLeetCode53 {
    ...
    @Test
    public void testMaxSubArray_1a() {
        int[] nums = {-2, 1, -3, 4, -1, 2, 1, -5, 4};
        int expected = 6;
        Assertions.assertEquals(expected, obj.maxSubArrayOfOtherOne(nums));
    }

    @Test
    public void testMaxSubArray_2a() {
        int[] nums = {5, 4, -1, 7, 8};
        int expected = 23;
        Assertions.assertEquals(expected, obj.maxSubArrayOfOtherOne(nums));
    }
    ...
    @Test
    public void testMaxSubArray_3a() {
        int[] nums = {4};
        int expected = 4;
        Assertions.assertEquals(expected, obj.maxSubArrayOfOtherOne(nums));
    }
    ...
    @Test
    public void testMaxSubArray_4a() {
        int[] nums = {-2, 0, -3, -1, -5};
        int expected = 0;
        Assertions.assertEquals(expected, obj.maxSubArrayOfOtherOne(nums));
    }
    ...
    @Test
    public void testMaxSubArray_5a() {
        int[] nums = {-2, -3, -1, -5, -2, -3, -1, -5};
        int expected = -1;
        Assertions.assertEquals(expected, obj.maxSubArrayOfOtherOne(nums));
    }
    ...
    @Test
    public void testMaxSubArray_6a() {
        int[] nums = {-2, -3, -1, -5, -2, -3, -1, -5, 0};
        int expected = 0;
        Assertions.assertEquals(expected, obj.maxSubArray(nums));
    }
    ...
    @Test
    public void testMaxSubArray_7a() {
        int[] nums = {-2, 1,2,3,4};
        int expected = 10;
        Assertions.assertEquals(expected, obj.maxSubArray(nums));
    }
